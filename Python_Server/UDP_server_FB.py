...
while (t_new <= 30.0):
    ...
    serverSock.sendto(WW + 'x' + VV, addr)
...
plt.subplot(6, 1, 2)
plt.plot(Time_val_khepera, V,'-r') 
plt.ylabel('Velocity (mm/sec)')

plt.subplot(6, 1, 3)
plt.plot(Time_val_khepera, W,'-g') 
plt.ylabel('Angular (rad/sec)')

plt.subplot(6, 1, 4)
plt.plot(Time_val_khepera, X,'-c') 
plt.ylabel('X (mm)')

plt.subplot(6, 1, 5)
plt.plot(Time_val_khepera, Y,'-y') 
plt.ylabel('Y (mm)')

plt.subplot(6, 1, 6)
plt.plot(Time_val_khepera, THETA,'-k') 
